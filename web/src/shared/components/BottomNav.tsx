...
const navItems: NavItem[] = [
  {
    ...
    activeIcon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        <path d="M11.47 3.84a.75.75 0 011.06 0l7.5 7.5a.75.75 0 11-1.06 1.06l-6.97-6.97-6.97 6.97a.75.75 0 01-1.06-1.06l7.5-7.5zM12 17.25a.75.75 0 01.75.75v3a.75.75 0 01-1.5 0v-3a.75.75 0 01.75-.75z" />
        <path d="M4.5 10.5a.75.75 0 00-.75.75v9a.75.75 0 00.75.75h5.25v-4.5a1.5 1.5 0 013 0v4.5H18a.75.75 0 00.75-.75v-9a.75.75 0 00-.22-.53l-6-6a.75.75 0 00-1.06 0l-6 6a.75.75 0 00-.22.53z" />
      </svg>
    ),
  },
  {
